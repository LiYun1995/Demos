...
$.fn.pagination.defaults={total:1,pageSize:15,pageNumber:1,pageList:[15,30,50,100,200],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_d1,_d2){
},onBeforeRefresh:function(_d3,_d4){
},onRefresh:function(_d5,_d6){
},onChangePageSize:function(_d7){
},beforePageText:"第",afterPageText:"页 共 {pages} 页",displayMsg:"显示 {from} 到 {to} 条数据，共 {total} 条数据",nav:{first:{iconCls:"pagination-first",handler:function(){
