	...
	<div class="index-box">
		<div class="main-box">
			...
			<div class="learn-flow">
				...
				<div class="learn-arrow-box">
					<!--修改：去掉 <div class="arrow-box-title">三类人员无需考试</div> -->
					<img class="arrow-box-icon" src="../assets/images/learnArrow.png"/>
				</div>
			...
			<div class="message">
				<div class="news-box pull-left" style="margin-right: 1%;">
					<div class="news-box-head" style="margin-bottom: -10px;">
			...
			<div class="news-group">
				<div class="news-group-box">
					<div class="head">
						<div class="box pull-left">
							<div class="title" style="width:110px">专业技术人员</div>
						</div>
				...
				<div class="news-group-box" style="margin:0px 0.5% 0px 1%">
					<div class="head">
						<div class="box pull-left">
							<div class="title" style="width:145px">职业（执业）培训</div>
						</div>
				...
				<div class="news-group-box" style="margin:0px 1% 0px 0.5%">
					<div class="head">
						<div class="box pull-left">
							<div class="title" style="width:90px">培训合格证</div>
						</div>
				...
				<div class="news-group-box">
					<div class="head">
						<div class="box pull-left" style="width:80px">
